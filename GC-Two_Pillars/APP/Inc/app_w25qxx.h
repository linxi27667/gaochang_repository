...
/* 操作日志环形缓冲 */
#define W25Q_RISE_JOURNAL_ADDR          0x00010000U
#define W25Q_RISE_JOURNAL_SECTOR_SIZE   0x00001000U
#define W25Q_RISE_JOURNAL_SECTOR_COUNT  16U

/* Maintenance usage ledger. Kept separate from the rise upload journal so a
 * maintenance reset never needs to erase or reinterpret transport history. */
#define W25Q_MAINTENANCE_LEDGER_ADDR          0x00020000U
#define W25Q_MAINTENANCE_LEDGER_SECTOR_SIZE   0x00001000U
