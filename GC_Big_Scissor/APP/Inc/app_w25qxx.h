 ...
 * 0x007000  报警日志环形缓冲
 * 0x008000-0x017FFF  上升次数离线队列 (64KB)
 * 0x018000+ 预留 (OTA 等)
 */
...
/* Offline rise-count queue. Kept in the previously reserved area. */
...
/* Append-only maintenance ledger: four 4 KB sectors, independent of queue. */
