                                                         ...
                                                         int16_t csq)
{
    ...
    uint8_t sub_lower_limit = App_IO_Read(IO_IN_SUB_LOWER_LIMIT);
    ...
    len = snprintf(buf, size,
                   ...
                   "\"estop\":%u,\"upper_limit\":%u,\"sub_upper_limit\":%u,\"lower_limit\":%u,\"sub_lower_limit\":%u,"
                                             ...
                                             uint32_t seq)
{
    ...
    len = snprintf(buf, size,
                   ...
                   "\"lower_limit\":%u,\"sub_lower_limit\":%u,\"photoelectric\":%u},"
