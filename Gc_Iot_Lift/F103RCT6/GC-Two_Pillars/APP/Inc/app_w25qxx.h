 ...
 * 0x0600 OpLog (256B)
 * 0x0700 Rise Journal 8×256 → 至 0x0EFF
 * 0x0F00 Maint Ledger 8×256 → 至 0x16FF
 * 0x1FF0 FRAM self-test
 */
...
#define W25Q_RISE_JOURNAL_ADDR          0x0700U
#define W25Q_RISE_JOURNAL_SECTOR_SIZE   0x0100U
#define W25Q_RISE_JOURNAL_SECTOR_COUNT  8U

#define W25Q_MAINTENANCE_LEDGER_ADDR          0x0F00U
#define W25Q_MAINTENANCE_LEDGER_SECTOR_SIZE   0x0100U
#define W25Q_MAINTENANCE_LEDGER_SECTOR_COUNT  8U
