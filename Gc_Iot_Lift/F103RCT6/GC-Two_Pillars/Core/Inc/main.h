...
/**
  ******************************************************************************
  * @file           : main.h
  * @brief          : Header for main.c (STM32F103RCT6 GC-Two_Pillars)
  ******************************************************************************
  */
...
/* F103 仅一颗 RUN 灯：COM/POWER 映射为空操作或复用 RUN */
#define LED_COM_ON()              ((void)0)
#define LED_COM_OFF()             ((void)0)
#define LED_COM_TOGGLE()          ((void)0)
#define LED_POWER_ON()            LED_RUN_ON()
#define LED_POWER_OFF()           LED_RUN_OFF()
