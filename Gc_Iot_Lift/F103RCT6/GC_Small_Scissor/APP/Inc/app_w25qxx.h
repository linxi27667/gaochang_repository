 ...
 * 0x0400 Stats/RiseCounter A / 0x0500 Stats/RiseCounter B
 * 0x0600 OpLog 256B
 * 0x0800 Maintenance journal 8×256 → 至 0x0FFF
 * 0x1FF0 self-test
 */
...
#define W25Q_MAINTENANCE_JOURNAL_ADDR         0x0800U
