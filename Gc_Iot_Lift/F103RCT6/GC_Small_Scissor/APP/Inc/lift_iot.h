...
#define LIFT_IOT_DEVICE_ID          "gaochang_lift_f103rct6"
#define LIFT_IOT_DEVICE_NAME        "Gaochang-SmallScissor-F103-01"
#define LIFT_IOT_DEVICE_MODEL       "GC-F103-SSCISSOR"
...
} lift_iot_maintenance_t;

void LiftIot_Init(void);
void LiftIot_Poll(void);

/* Retained as no-op compatibility hooks for older DTU task modules. */
