...
static const io_in_pin_t s_in_map[IO_IN_MAX] = {
    ...
    [IO_IN_LOWER_LIMIT] = { LIMIT_DOWN_GPIO_Port, LIMIT_DOWN_Pin, 1U, 20U }, /* PE6 lower limit, active-high; masks photo only */
};
...
static const io_out_pin_t s_out_map[IO_OUT_MAX] = {
    ...
    [IO_OUT_DROP_VALVE] = { OUT_DOWN_VALVE_RELAY_GPIO_Port, OUT_DOWN_VALVE_RELAY_Pin, 1U }, /* PD9 涓嬮檷闃€缁х數鍣紝楂樼數骞冲惛鍚?*/
