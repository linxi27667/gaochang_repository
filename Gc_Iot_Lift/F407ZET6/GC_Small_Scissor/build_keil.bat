...
REM ==========================================
REM Keil5 build script for GC_Small_Scissor
...
set PROJ_PATH=%~dp0MDK-ARM\GC_Small_Scissor.uvprojx
set LOG_DIR=%~dp0MDK-ARM\logs
set LOG_FILE=%LOG_DIR%\keil_build.log
set AXF_PATH=%~dp0MDK-ARM\GC_Small_Scissor\GC_Small_Scissor.axf
set BIN_PATH=%~dp0MDK-ARM\GC_Small_Scissor\GC_Small_Scissor.bin
