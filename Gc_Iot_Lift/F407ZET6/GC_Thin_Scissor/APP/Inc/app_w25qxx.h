...
/* Persistent rise accounting journal.  This range is separate from the
 * legacy storage/config/stats sectors above. */
#define W25Q_RISE_STATS_JOURNAL_ADDR          0x00008000U
#define W25Q_RISE_STATS_JOURNAL_SECTOR_SIZE   0x00001000U
#define W25Q_RISE_STATS_JOURNAL_SECTOR_COUNT  16U
#define W25Q_RISE_STATS_REMAINDER_LIMIT_MS    3000U

/* Maintenance accounting is deliberately isolated from the legacy and rise
 * journals.  The four-sector ring limits erase wear while retaining enough
 * committed records for power-loss recovery. */
#define W25Q_MAINTENANCE_JOURNAL_ADDR          0x00020000U
#define W25Q_MAINTENANCE_JOURNAL_SECTOR_SIZE   0x00001000U
#define W25Q_MAINTENANCE_JOURNAL_SECTOR_COUNT  4U
